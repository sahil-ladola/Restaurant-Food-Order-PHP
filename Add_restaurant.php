...
<body>
    <header class="p-3 border-bottom sticky-top bg-light">
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <a href="Add_restaurant.php" class="d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none">

                    <img class="bi me-2" width="40" height="40" role="img" aria-label="Bootstrap" src="Image/LOGO/foodive-logos_black.png" alt="FOODIVE">
                </a>
    ...
    <div>
        <img src="Image/Img/Add-Restro.jpg" class="img-fluid mh-100 mw-100" alt="Add-Restro" style="width: 100%; height: 585px;">
    </div>

    <div id="Register">
        <div class="px-4 text-center">
            <img class="d-block mx-auto" src="Image/LOGO/foodive-logos_black.png" alt="FOODIVE" width="300" height="300">
            ...
            <div class="col-lg-6 mx-auto">
                ...
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center pb-5">
                    <button type="button" class="btn btn-primary btn-lg px-4 gap-3 mb-5">Register your restaurant</button>
                </div>
                <hr>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="card shadow p-3 mb-5 bg-white rounded">
                            <div class="card-body">
                                <img src="Image/Icon/Restro.svg" height="70" width="70" class="card-img-top mb-2" alt="Restro_icon">
                    ...
                    <div class="col-sm-3">
                        <div class="card shadow p-3 mb-5 bg-white rounded">
                            <div class="card-body">
                                <img src="Image/Icon/Order.svg" height="70" width="70" class="card-img-top mb-2" alt="Order_icon">
                    ...
                    <div class="col-sm-3">
                        <div class="card shadow p-3 mb-5 bg-white rounded">
                            <div class="card-body">
                                <img src="Image/Icon/Customer.svg" height="70" width="70" class="card-img-top mb-2" alt="Customer_icon">
                    ...
                    <div class="col-sm-3">
                        <div class="card shadow p-3 mb-5 bg-white rounded">
                            <div class="card-body">
                                <img src="Image/Icon/Delivery.svg" height="70" width="70" class="card-img-top mb-2" alt="Delivery_icon">
                                <h5 class="card-title text-center">300+</h5>
        ...
        <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
            <div class="col d-flex align-items-start">
                <div class="icon-square bg-light text-dark flex-shrink-0 me-3">
                    <img src="Image/Icon/Restro.svg" class="bi" alt="Restro-icon">
                </div>
                <div class="mb-4">
                    <h2>Step 1</h2>
            ...
            <div class="col d-flex align-items-start">
                <div class="icon-square bg-light text-dark flex-shrink-0 me-3">
                    <img src="Image/Icon/Order.svg" class="bi" alt="Order-icon">
                </div>
                <div class="mb-4">
                    <h2>Step 2</h2>
            ...
            <div class="col d-flex align-items-start">
                <div class="icon-square bg-light text-dark flex-shrink-0 me-3">
                    <img src="Image/Icon/Delivery.svg" class="bi" alt="Delivery-icon">
                </div>
                <div class="mb-4">
                    <h2>Step 3</h2>
    ...
    <div class="container marketing" id="partner">
        ...
        <div class="row text-center pt-5">
            <div class="col-lg-4">
                <img src="Image/Icon/User.png" class="bd-placeholder-img rounded-circle my-3" width="140" height="140" alt="User-icon">
